<?php /* Smarty version Smarty-3.1.7, created on 2017-11-04 16:27:32
         compiled from "G:\UwAmp\www\github\demo1\includes\runtime/../../layouts/v7\modules\Settings\LayoutEditor\FieldCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3153159fddb4ba03481-52941607%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '318adbce8c86d95f9a1f5917efb99b5409aad81b' => 
    array (
      0 => 'G:\\UwAmp\\www\\github\\demo1\\includes\\runtime/../../layouts/v7\\modules\\Settings\\LayoutEditor\\FieldCreate.tpl',
      1 => 1509812344,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3153159fddb4ba03481-52941607',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59fddb4c71d18',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_59fddb4c71d18')) {function content_59fddb4c71d18($_smarty_tpl) {?>
...
" data-rule-required='true' style='width: 75%' /></div></div><?php if (!$_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value){?><div class="form-group supportedType lengthsupported"><label class="control-label fieldLabel col-sm-5">Field Name&nbsp;<span class="redColor">*</span></label><div class="controls col-sm-7"><input type="text" class='inputElement col-sm-9' maxlength="50" name="fieldName"value="<?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
" data-rule-required='true' style='width: 75%' /></div></div><div class="form-group supportedType lengthsupported"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('LBL_LENGTH',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
